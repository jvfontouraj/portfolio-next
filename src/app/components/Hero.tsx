...
export function Hero({ lang }: { lang: string }) {
  ...
  return (
    <section className="mb-12 mt-5 flex w-full flex-col-reverse gap-5 md:flex-row md:gap-0 2xl:mb-[110px] 2xl:h-[calc(100vh-260px)]">
      <div className="flex w-full items-center justify-center md:w-1/2">
        <div className="m-auto flex w-fit flex-col items-start justify-center gap-5 md:gap-14 2xl:gap-20">
          ...
          <p className="text-center text-base md:max-w-[39ch] md:text-left 2xl:text-lg">
            {content.text}
          </p>
          <div className="mx-auto flex flex-col items-center gap-5 md:mx-0 md:flex-row md:gap-10">
            <Link
              ...
              target="_blank"
              download
              className="flex h-12 w-44 items-center justify-center gap-3 rounded-[10px] border border-neutral-800 bg-white text-base shadow-md transition-colors hover:bg-neutral-200 dark:border-white dark:bg-neutral-800 md:h-12 md:w-48 md:text-base 2xl:h-14 2xl:w-56 2xl:text-lg"
            >
